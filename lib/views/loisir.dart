  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
          ...
          appBar: AppbarCustom(title: "Plan Loisirs", color: ColorsSys.colorLoi),
          body: Column(
            children: <Widget>[
              Expanded(
                flex: 1,
                        ...
                        builder: (context, snapshot) {
                          ...
                          if (data == null) {
                            return Container(
                              ...
                              child: CircularProgressIndicator(valueColor:AlwaysStoppedAnimation<Color>(ColorsSys.colorLoi)),
                            );
                          }
