...
import 'package:gabon_plan/views/loisir.dart';
...
class ResultatLoisir extends StatefulWidget {


  final int id;
  final String libelle;

  const ResultatLoisir({required this.id, required this.libelle});

  @override
  _ResultatLoisirState createState() => _ResultatLoisirState();
}

class _ResultatLoisirState extends State<ResultatLoisir> {
              ...
              Expanded(
                ...
                child: Column(
                  children: [
                    ...
                    Expanded(child: Text(widget.libelle, style: TextStyle(color: ColorsSys.colorLoi, fontSize: 17.0),))
                  ],
                ),
              ),
              Expanded(
                ...
                child: Padding(
                    ...
                    child: FutureBuilder(
                        future: RequestHTTP.fetchAllFilterLoisirForCity(1, widget.id),
